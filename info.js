...
const ASSOCIATIONS = [
  ...
  { name: 'The SeaCleaners', logo: LOGOS['the-seacleaners'], facts: ["The SeaCleaners : l'association concoit le Manta, un navire dedie a la collecte du plastique en mer.", "Le Manta doit pouvoir recolter jusqu'a plusieurs milliers de tonnes de dechets plastiques par an."] },
